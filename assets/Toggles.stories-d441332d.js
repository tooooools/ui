import{r as i,h as a}from"./ensure-4e62e800.js";import{T as l}from"./Toggles-db29a1c6.js";import{I as e}from"./circle-8871eb28.js";import"./Button-dbe5ef07.js";const b={title:"Inputs/<Toggles>",render:o=>i(a(l,o),null).nodes[0],argTypes:{title:{type:"string",description:"`store-`"},value:{type:"string",description:"`store-`"},options:{type:"array",description:["`store-`","`[{ value?: mixed, icon?: string, label?: string, disabled?: boolean, hidden?: boolean }, …]`"].map(o=>`<p>${o}</p>`).join(`
...
//# sourceMappingURL=Toggles.stories-d441332d.js.map
