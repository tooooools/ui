import{d as E}from"./index-72f598f6.js";import{d as M}from"./index-633d3215.js";const{logger:x}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var p="backgrounds",{document:s,window:B}=E.global,S=()=>B.matchMedia("(prefers-reduced-motion: reduce)").matches,_=(r,e=[],d)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===d);if(t)return t.value;if(d){let a=e.map(i=>i.name).join(", ");x.warn(M`
    ...
    `},[o]);return k(()=>{let b=e.viewMode==="docs"?`addon-backgrounds-grid-docs-${e.id}`:"addon-backgrounds-grid";if(!i){v(b);return}A(b,$)},[i,$,e]),r()},H=[T,O],R={[p]:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}},G={[p]:null};export{H as decorators,G as globals,R as parameters};
//# sourceMappingURL=preview-4f9f1cb4.js.map
