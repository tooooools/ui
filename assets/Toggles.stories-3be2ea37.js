import{r as i,h as a}from"./ensure-4e62e800.js";import{T as l}from"./Toggles-c31952c6.js";import{I as e}from"./circle-8871eb28.js";import"./Button-cadf5417.js";const b={title:"Inputs/<Toggles>",render:o=>i(a(l,o),null).nodes[0],argTypes:{title:{type:"string",description:"`store-`"},value:{type:"string",description:"`store-`"},options:{type:"array",description:["`store-`","`[{ value?: mixed, icon?: string, label?: string, disabled?: boolean, hidden?: boolean }, …]`"].map(o=>`<p>${o}</p>`).join(`
...
//# sourceMappingURL=Toggles.stories-3be2ea37.js.map
