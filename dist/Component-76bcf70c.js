...
function Y(t, e = document.body, n) {
  let s = 0;
  const o = d(t, e && U.has(e.tagName));
  let r = { _collector: o };
  if (I(r), u(r, function(i) {
  ...
  if ((!n || n.mounted) && (O(r), u(r, function(i) {
...
class q {
  ...
  get dataProps() {
    return Object.entries(this.props).filter(([e]) => e.startsWith("data-")).reduce((e, [n, s]) => ({ ...e, [n]: s }), {});
  }
  ...
  refArray(e, n = !1) {
    ...
    let o = s.length, r, i;
    return n && (r = this.refs.__pools || (this.refs.__pools = {}), i = r[e] || (r[e] = []), i.length && (o = i.pop())), s[o] = null, function(l) {
      s[o] = l, n && i.push(o);
    };
  }
...
//# sourceMappingURL=Component-76bcf70c.js.map
